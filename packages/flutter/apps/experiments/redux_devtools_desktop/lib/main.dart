...
// TODO: when should we do process?.kill(); ?
// - it was done in tearDown whhen this was a test
...
void main() async {
  ...
  process = await Process.start('$sdk/xcodebuild/ReleaseARM64/dart', [
    ...
    '/Users/nick/git/orgs/enspyrco/monorepo/packages/flutter/apps/experiments/redux_devtools_desktop/lib/sample_main.dart'
  ]);
