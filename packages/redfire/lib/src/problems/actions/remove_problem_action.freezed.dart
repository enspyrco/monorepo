...
/// @nodoc
@JsonSerializable()
class _$_RemoveProblemAction extends _RemoveProblemAction {
  const _$_RemoveProblemAction(this.info) : super._();
...
abstract class _RemoveProblemAction extends RemoveProblemAction {
  const factory _RemoveProblemAction(ProblemInfo info) = _$_RemoveProblemAction;
  const _RemoveProblemAction._() : super._();
