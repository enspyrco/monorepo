...
class _$_UpdateSettingsAction extends _UpdateSettingsAction {
  const _$_UpdateSettingsAction({required this.platform}) : super._();
...
abstract class _UpdateSettingsAction extends UpdateSettingsAction {
  const factory _UpdateSettingsAction({required PlatformsEnum platform}) =
      _$_UpdateSettingsAction;
  const _UpdateSettingsAction._() : super._();
