...
abstract class FlutterBox2DPlatform extends PlatformInterface {
  ...
  B2WorldPlatform b2World_1(B2Vec2Platform gravity) {
    throw UnimplementedError(
        'b2World_1(B2Vec2Platform gravity) has not been implemented.');
  }
  ...
  B2TransformPlatform b2Transform_2(
      B2Vec2Platform position, B2RotPlatform rotation) {
    throw UnimplementedError(
        'b2Transform_2(B2Vec2Platform position, B2RotPlatform rotation) has not been implemented.');
  }
  ...
  B2Vec2Platform b2Vec2_2(double x, double y) {
    throw UnimplementedError(
        'b2Vec2_2(double x, double y) has not been implemented.');
  }
  ...
  B2Vec3Platform b2Vec3_3(double x, double y, double z) {
    throw UnimplementedError(
        'b2Vec3_3(double x, double y, double z) has not been implemented.');
  }
  ...
  B2ColorPlatform b2Color_3(double r, double g, double b) {
    throw UnimplementedError(
        'b2Color_3(double r, double g, double b) has not been implemented.');
  }
  ...
  JSDestructionListenerPlatform JSDestructionListener_0() {
    throw UnimplementedError(
        'JSDestructionListener_0() has not been implemented.');
  }

  B2DistanceJointDefPlatform b2DistanceJointDef_0() {
    throw UnimplementedError(
        'b2DistanceJointDef_0() has not been implemented.');
  }
  ...
  B2FrictionJointDefPlatform b2FrictionJointDef_0() {
    throw UnimplementedError(
        'b2FrictionJointDef_0() has not been implemented.');
  }
  ...
  B2Mat22Platform b2Mat22_2(B2Vec2Platform a11, B2Vec2Platform a12) {
    throw UnimplementedError(
        'b2Mat22_2(B2Vec2Platform a11, B2Vec2Platform a12) has not been implemented.');
  }

  B2Mat22Platform b2Mat22_4(double a11, double a12, double a21, double a22) {
    throw UnimplementedError(
        'b2Mat22_4(double a11, double a12, double a21, double a22) has not been implemented.');
  }
  ...
  B2Mat33Platform b2Mat33_3(
      B2Vec3Platform c1, B2Vec3Platform c2, B2Vec3Platform c3) {
    throw UnimplementedError(
        'b2Mat33_3(B2Vec3Platform c1, B2Vec3Platform c2, B2Vec3Platform c3) has not been implemented.');
  }
  ...
  B2PrismaticJointDefPlatform b2PrismaticJointDef_0() {
    throw UnimplementedError(
        'b2PrismaticJointDef_0() has not been implemented.');
  }
  ...
  B2RevoluteJointDefPlatform b2RevoluteJointDef_0() {
    throw UnimplementedError(
        'b2RevoluteJointDef_0() has not been implemented.');
  }
