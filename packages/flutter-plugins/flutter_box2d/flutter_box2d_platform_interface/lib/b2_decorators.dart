...
class B2Shape {
  ...
  bool testPoint(B2Transform xf, B2Vec2 p) =>
      _delegate.testPoint(xf._delegate, p._delegate);
  bool rayCast(B2RayCastOutput output, B2RayCastInput input,
          B2Transform transform, int childIndex) =>
      _delegate.rayCast(
          output._delegate, input._delegate, transform._delegate, childIndex);
  void computeAABB(B2AABB aabb, B2Transform xf, int childIndex) =>
      _delegate.computeAABB(aabb._delegate, xf._delegate, childIndex);
  void computeMass(B2MassData massData, double density) =>
      _delegate.computeMass(massData._delegate, density);
...
class B2Joint {
  ...
  B2Vec2 getReactionForce(double inv_dt) =>
      B2Vec2._(_delegate.getReactionForce(inv_dt));
...
class B2Contact {
  ...
  void getWorldManifold(B2WorldManifold manifold) =>
      _delegate.getWorldManifold(manifold._delegate);
...
class JSContactListener {
  ...
  void beginContact(B2Contact contact) =>
      _delegate.beginContact(contact._delegate);
  ...
  void preSolve(B2Contact contact, B2Manifold oldManifold) =>
      _delegate.preSolve(contact._delegate, oldManifold._delegate);
  void postSolve(B2Contact contact, B2ContactImpulse impulse) =>
      _delegate.postSolve(contact._delegate, impulse._delegate);
  void dispose() => _delegate.dispose();
}
...
class B2World {
  ...
  B2World.from1(B2Vec2 gravity)
      : _delegate = FlutterBox2DPlatform.instance.b2World_1(gravity._delegate);
  ...
  B2Joint createJoint(B2JointDef def) =>
      B2Joint._(_delegate.createJoint(def._delegate));
...
class B2FixtureDef {
  ...
  B2FixtureUserData get userData =>
      B2FixtureUserData._(_delegate.get_userData());
  set userData(B2FixtureUserData arg0) =>
      _delegate.set_userData(arg0._delegate);
...
class B2Fixture {
  ...
  void setFilterData(B2Filter filter) =>
      _delegate.setFilterData(filter._delegate);
  ...
  B2FixtureUserData getUserData() =>
      B2FixtureUserData._(_delegate.getUserData());
  bool testPoint(B2Vec2 p) => _delegate.testPoint(p._delegate);
  bool rayCast(B2RayCastOutput output, B2RayCastInput input, int childIndex) =>
      _delegate.rayCast(output._delegate, input._delegate, childIndex);
  void getMassData(B2MassData massData) =>
      _delegate.getMassData(massData._delegate);
...
class B2Transform {
  ...
  B2Transform.from2(B2Vec2 position, B2Rot rotation)
      : _delegate = FlutterBox2DPlatform.instance
            .b2Transform_2(position._delegate, rotation._delegate);

  void setIdentity() => _delegate.setIdentity();
  void set(B2Vec2 position, double angle) =>
      _delegate.set(position._delegate, angle);
...
class JSRayCastCallback {
  ...
  double reportFixture(
          B2Fixture fixture, B2Vec2 point, B2Vec2 normal, double fraction) =>
      _delegate.reportFixture(
          fixture._delegate, point._delegate, normal._delegate, fraction);
  void dispose() => _delegate.dispose();
}
...
class JSQueryCallback {
  ...
  bool reportFixture(B2Fixture fixture) =>
      _delegate.reportFixture(fixture._delegate);
  void dispose() => _delegate.dispose();
}
...
class B2Body {
  ...
  B2Fixture createFixture1(B2FixtureDef shape) =>
      B2Fixture._(_delegate.createFixture1(shape._delegate));
  B2Fixture createFixture2(B2Shape shape, double density) =>
      B2Fixture._(_delegate.createFixture2(shape._delegate, density));
  void destroyFixture(B2Fixture fixture) =>
      _delegate.destroyFixture(fixture._delegate);
  ...
  void applyForce(B2Vec2 force, B2Vec2 point, bool wake) =>
      _delegate.applyForce(force._delegate, point._delegate, wake);
  void applyForceToCenter(B2Vec2 force, bool wake) =>
      _delegate.applyForceToCenter(force._delegate, wake);
  ...
  void applyLinearImpulse(B2Vec2 impulse, B2Vec2 point, bool wake) =>
      _delegate.applyLinearImpulse(impulse._delegate, point._delegate, wake);
  void applyLinearImpulseToCenter(B2Vec2 impulse, bool wake) =>
      _delegate.applyLinearImpulseToCenter(impulse._delegate, wake);
  ...
  B2Vec2 getWorldPoint(B2Vec2 localPoint) =>
      B2Vec2._(_delegate.getWorldPoint(localPoint._delegate));
  B2Vec2 getWorldVector(B2Vec2 localVector) =>
      B2Vec2._(_delegate.getWorldVector(localVector._delegate));
  B2Vec2 getLocalPoint(B2Vec2 worldPoint) =>
      B2Vec2._(_delegate.getLocalPoint(worldPoint._delegate));
  B2Vec2 getLocalVector(B2Vec2 worldVector) =>
      B2Vec2._(_delegate.getLocalVector(worldVector._delegate));
  B2Vec2 getLinearVelocityFromWorldPoint(B2Vec2 worldPoint) =>
      B2Vec2._(_delegate.getLinearVelocityFromWorldPoint(worldPoint._delegate));
  B2Vec2 getLinearVelocityFromLocalPoint(B2Vec2 localPoint) =>
      B2Vec2._(_delegate.getLinearVelocityFromLocalPoint(localPoint._delegate));
...
class B2BodyDef {
  ...
  set linearVelocity(B2Vec2 arg0) =>
      _delegate.set_linearVelocity(arg0._delegate);
...
class B2AABB {
  ...
  void combine2(B2AABB aabb1, B2AABB aabb2) =>
      _delegate.combine2(aabb1._delegate, aabb2._delegate);
  bool contains(B2AABB aabb) => _delegate.contains(aabb._delegate);
  bool rayCast(B2RayCastOutput output, B2RayCastInput input) =>
      _delegate.rayCast(output._delegate, input._delegate);
...
class B2EdgeShape implements B2Shape {
  ...
  void setOneSided(B2Vec2 v0, B2Vec2 v1, B2Vec2 v2, B2Vec2 v3) => _delegate
      .setOneSided(v0._delegate, v1._delegate, v2._delegate, v3._delegate);
  void setTwoSided(B2Vec2 v1, B2Vec2 v2) =>
      _delegate.setTwoSided(v1._delegate, v2._delegate);
  B2ShapeType getType() => _delegate.getType();
  int getChildCount() => _delegate.getChildCount();
  bool testPoint(B2Transform xf, B2Vec2 p) =>
      _delegate.testPoint(xf._delegate, p._delegate);
...
class B2WeldJointDef implements B2JointDef {
  ...
  void initialize(B2Body bodyA, B2Body bodyB, B2Vec2 anchor) =>
      _delegate.initialize(bodyA._delegate, bodyB._delegate, anchor._delegate);
...
class B2ChainShape implements B2Shape {
  ...
  void createLoop(B2Vec2 vertices, int count) =>
      _delegate.createLoop(vertices._delegate, count);
  void createChain(
          B2Vec2 vertices, int count, B2Vec2 prevVertex, B2Vec2 nextVertex) =>
      _delegate.createChain(vertices._delegate, count, prevVertex._delegate,
          nextVertex._delegate);
  void getChildEdge(B2EdgeShape edge, int index) =>
      _delegate.getChildEdge(edge._delegate, index);
  B2ShapeType getType() => _delegate.getType();
  int getChildCount() => _delegate.getChildCount();
  bool testPoint(B2Transform xf, B2Vec2 p) =>
      _delegate.testPoint(xf._delegate, p._delegate);
...
class JSContactFilter {
  ...
  bool shouldCollide(B2Fixture fixtureA, B2Fixture fixtureB) =>
      _delegate.shouldCollide(fixtureA._delegate, fixtureB._delegate);
  void dispose() => _delegate.dispose();
}
...
class JSDestructionListener {
  ...
  void sayGoodbyeJoint(B2Joint joint) =>
      _delegate.sayGoodbyeJoint(joint._delegate);
  void sayGoodbyeFixture(B2Fixture joint) =>
      _delegate.sayGoodbyeFixture(joint._delegate);
  void dispose() => _delegate.dispose();
}
...
class B2DistanceJointDef implements B2JointDef {
  ...
  void initialize(B2Body bodyA, B2Body bodyB, B2Vec2 anchorA, B2Vec2 anchorB) =>
      _delegate.initialize(bodyA._delegate, bodyB._delegate, anchorA._delegate,
          anchorB._delegate);
  B2Vec2 get localAnchorA => B2Vec2._(_delegate.get_localAnchorA());
  set localAnchorA(B2Vec2 arg0) => _delegate.set_localAnchorA(arg0._delegate);
  B2Vec2 get localAnchorB => B2Vec2._(_delegate.get_localAnchorB());
...
class JSDraw {
  ...
  void drawPolygon(B2Vec2 vertices, int vertexCount, B2Color color) =>
      _delegate.drawPolygon(vertices._delegate, vertexCount, color._delegate);
  void drawSolidPolygon(B2Vec2 vertices, int vertexCount, B2Color color) =>
      _delegate.drawSolidPolygon(
          vertices._delegate, vertexCount, color._delegate);
  void drawCircle(B2Vec2 center, double radius, B2Color color) =>
      _delegate.drawCircle(center._delegate, radius, color._delegate);
  void drawSolidCircle(
          B2Vec2 center, double radius, B2Vec2 axis, B2Color color) =>
      _delegate.drawSolidCircle(
          center._delegate, radius, axis._delegate, color._delegate);
  void drawSegment(B2Vec2 p1, B2Vec2 p2, B2Color color) =>
      _delegate.drawSegment(p1._delegate, p2._delegate, color._delegate);
  void drawTransform(B2Transform xf) => _delegate.drawTransform(xf._delegate);
  void drawPoint(B2Vec2 p, double size, B2Color color) =>
      _delegate.drawPoint(p._delegate, size, color._delegate);
  void dispose() => _delegate.dispose();
}
...
class B2Manifold {
  ...
  B2ManifoldPoint pointsElementAt(int arg0) =>
      B2ManifoldPoint._(_delegate.get_points(arg0));
  void pointsInsert(int arg0, B2ManifoldPoint arg1) =>
      _delegate.set_points(arg0, arg1._delegate);
...
class B2WorldManifold {
  ...
  void initialize(B2Manifold manifold, B2Transform xfA, double radiusA,
          B2Transform xfB, double radiusB) =>
      _delegate.initialize(
          manifold._delegate, xfA._delegate, radiusA, xfB._delegate, radiusB);
  ...
  void pointsInsert(int arg0, B2Vec2 arg1) =>
      _delegate.set_points(arg0, arg1._delegate);
...
class B2Mat22 {
  ...
  B2Mat22.from2(B2Vec2 a11, B2Vec2 a12)
      : _delegate = FlutterBox2DPlatform.instance
            .b2Mat22_2(a11._delegate, a12._delegate);
...
class B2Mat33 {
  ...
  B2Mat33.from3(B2Vec3 c1, B2Vec3 c2, B2Vec3 c3)
      : _delegate = FlutterBox2DPlatform.instance
            .b2Mat33_3(c1._delegate, c2._delegate, c3._delegate);
...
class B2PolygonShape implements B2Shape {
  ...
  void set(B2Vec2 vertices, int vertexCount) =>
      _delegate.set(vertices._delegate, vertexCount);
  void setAsBox2(double hx, double hy) => _delegate.setAsBox2(hx, hy);
  void setAsBox4(double hx, double hy, B2Vec2 center, double angle) =>
      _delegate.setAsBox4(hx, hy, center._delegate, angle);
  B2ShapeType getType() => _delegate.getType();
  int getChildCount() => _delegate.getChildCount();
  bool testPoint(B2Transform xf, B2Vec2 p) =>
      _delegate.testPoint(xf._delegate, p._delegate);
  ...
  B2Vec2 m_verticesElementAt(int arg0) =>
      B2Vec2._(_delegate.get_m_vertices(arg0));
  void m_verticesInsert(int arg0, B2Vec2 arg1) =>
      _delegate.set_m_vertices(arg0, arg1._delegate);
  B2Vec2 m_normalsElementAt(int arg0) =>
      B2Vec2._(_delegate.get_m_normals(arg0));
  void m_normalsInsert(int arg0, B2Vec2 arg1) =>
      _delegate.set_m_normals(arg0, arg1._delegate);
  int get m_count => _delegate.get_m_count();
  set m_count(int arg0) => _delegate.set_m_count(arg0);
  B2ShapeType get m_type => _delegate.get_m_type();
  set m_type(B2ShapeType arg0) => _delegate.set_m_type(arg0);
...
class B2PrismaticJointDef implements B2JointDef {
  ...
  void initialize(B2Body bodyA, B2Body bodyB, B2Vec2 anchor, B2Vec2 axis) =>
      _delegate.initialize(
          bodyA._delegate, bodyB._delegate, anchor._delegate, axis._delegate);
  B2Vec2 get localAnchorA => B2Vec2._(_delegate.get_localAnchorA());
  set localAnchorA(B2Vec2 arg0) => _delegate.set_localAnchorA(arg0._delegate);
  B2Vec2 get localAnchorB => B2Vec2._(_delegate.get_localAnchorB());
  set localAnchorB(B2Vec2 arg0) => _delegate.set_localAnchorB(arg0._delegate);
...
class B2PulleyJointDef implements B2JointDef {
  ...
  void initialize(B2Body bodyA, B2Body bodyB, B2Vec2 groundAnchorA,
          B2Vec2 groundAnchorB, B2Vec2 anchorA, B2Vec2 anchorB, double ratio) =>
      _delegate.initialize(
          bodyA._delegate,
          bodyB._delegate,
          groundAnchorA._delegate,
          groundAnchorB._delegate,
          anchorA._delegate,
          anchorB._delegate,
          ratio);
...
class B2MotorJoint implements B2Joint {
  ...
  void setLinearOffset(B2Vec2 linearOffset) =>
      _delegate.setLinearOffset(linearOffset._delegate);
...
class B2MotorJointDef implements B2JointDef {
  ...
  void initialize(B2Body bodyA, B2Body bodyB) =>
      _delegate.initialize(bodyA._delegate, bodyB._delegate);
...
class B2Rope {
  ...
  void step(double timeStep, int iterations, B2Vec2 position) =>
      _delegate.step(timeStep, iterations, position._delegate);
