...
import 'test_plugin_ffi_bindings_generated.dart';
...
const String _libName = 'test_plugin_ffi';

/// The dynamic library in which the symbols for [TestPluginFfiBindings] can be found.
...
final TestPluginFfiBindings _bindings = TestPluginFfiBindings(_dylib);
