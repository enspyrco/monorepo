...
class FlutterBox2DWeb extends FlutterBox2DPlatform {
  ...
  JSContactListenerPlatform JSContactListener_0() =>
      JSContactListenerJSAdapter();

  B2WorldPlatform b2World_1(covariant B2Vec2JSAdapter gravity) =>
      B2WorldJSAdapter.from1(gravity);

  B2FixtureDefPlatform b2FixtureDef_0() => B2FixtureDefJSAdapter();

  B2TransformPlatform b2Transform_0() => B2TransformJSAdapter();

  B2TransformPlatform b2Transform_2(covariant B2Vec2JSAdapter position,
          covariant B2RotJSAdapter rotation) =>
      B2TransformJSAdapter.from2(position, rotation);

  JSRayCastCallbackPlatform JSRayCastCallback_0() =>
      JSRayCastCallbackJSAdapter();
  ...
  B2Mat22Platform b2Mat22_2(
          covariant B2Vec2JSAdapter a11, covariant B2Vec2JSAdapter a12) =>
      B2Mat22JSAdapter.from2(a11, a12);

  B2Mat22Platform b2Mat22_4(double a11, double a12, double a21, double a22) =>
      B2Mat22JSAdapter.from4(a11, a12, a21, a22);

  B2Mat33Platform b2Mat33_0() => B2Mat33JSAdapter();

  B2Mat33Platform b2Mat33_3(covariant B2Vec3JSAdapter c1,
          covariant B2Vec3JSAdapter c2, covariant B2Vec3JSAdapter c3) =>
      B2Mat33JSAdapter.from3(c1, c2, c3);
