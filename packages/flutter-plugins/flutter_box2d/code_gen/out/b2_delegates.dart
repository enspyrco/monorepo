...
abstract class B2ShapePlatform {
	...
	bool rayCast(covariant B2RayCastOutputPlatform output, covariant B2RayCastInputPlatform input, covariant B2TransformPlatform transform, int childIndex);
	void computeAABB(covariant B2AABBPlatform aabb, covariant B2TransformPlatform xf, int childIndex);
...
abstract class JSContactListenerPlatform {
	...
	void preSolve(covariant B2ContactPlatform contact, covariant B2ManifoldPlatform oldManifold);
	void postSolve(covariant B2ContactPlatform contact, covariant B2ContactImpulsePlatform impulse);
	void dispose();
}
...
abstract class B2FixturePlatform {
	...
	bool rayCast(covariant B2RayCastOutputPlatform output, covariant B2RayCastInputPlatform input, int childIndex);
...
abstract class JSRayCastCallbackPlatform {
	...
	double reportFixture(covariant B2FixturePlatform fixture, covariant B2Vec2Platform point, covariant B2Vec2Platform normal, double fraction);
	void dispose();
}
...
abstract class B2BodyPlatform {
	...
	void applyForce(covariant B2Vec2Platform force, covariant B2Vec2Platform point, bool wake);
	void applyForceToCenter(covariant B2Vec2Platform force, bool wake);
	void applyTorque(double torque, bool awake);
	void applyLinearImpulse(covariant B2Vec2Platform impulse, covariant B2Vec2Platform point, bool wake);
	...
	B2Vec2Platform getLinearVelocityFromWorldPoint(covariant B2Vec2Platform worldPoint);
	B2Vec2Platform getLinearVelocityFromLocalPoint(covariant B2Vec2Platform localPoint);
...
abstract class B2AABBPlatform {
	...
	bool rayCast(covariant B2RayCastOutputPlatform output, covariant B2RayCastInputPlatform input);
...
abstract class B2EdgeShapePlatform {
	...
	void setOneSided(covariant B2Vec2Platform v0, covariant B2Vec2Platform v1, covariant B2Vec2Platform v2, covariant B2Vec2Platform v3);
...
abstract class B2WeldJointDefPlatform {
	...
	void initialize(covariant B2BodyPlatform bodyA, covariant B2BodyPlatform bodyB, covariant B2Vec2Platform anchor);
...
abstract class B2ChainShapePlatform {
	...
	void createChain(covariant B2Vec2Platform vertices, int count, covariant B2Vec2Platform prevVertex, covariant B2Vec2Platform nextVertex);
...
abstract class JSContactFilterPlatform {
	...
	bool shouldCollide(covariant B2FixturePlatform fixtureA, covariant B2FixturePlatform fixtureB);
	void dispose();
}
...
abstract class B2DistanceJointDefPlatform {
	...
	void initialize(covariant B2BodyPlatform bodyA, covariant B2BodyPlatform bodyB, covariant B2Vec2Platform anchorA, covariant B2Vec2Platform anchorB);
	B2Vec2Platform get_localAnchorA();
	void set_localAnchorA(covariant B2Vec2Platform arg0);
	B2Vec2Platform get_localAnchorB();
	void set_localAnchorB(covariant B2Vec2Platform arg0);
...
abstract class JSDrawPlatform {
	...
	void drawPolygon(covariant B2Vec2Platform vertices, int vertexCount, covariant B2ColorPlatform color);
	void drawSolidPolygon(covariant B2Vec2Platform vertices, int vertexCount, covariant B2ColorPlatform color);
	void drawCircle(covariant B2Vec2Platform center, double radius, covariant B2ColorPlatform color);
	void drawSolidCircle(covariant B2Vec2Platform center, double radius, covariant B2Vec2Platform axis, covariant B2ColorPlatform color);
	void drawSegment(covariant B2Vec2Platform p1, covariant B2Vec2Platform p2, covariant B2ColorPlatform color);
	void drawTransform(covariant B2TransformPlatform xf);
	void drawPoint(covariant B2Vec2Platform p, double size, covariant B2ColorPlatform color);
	void dispose();
}
...
abstract class B2WorldManifoldPlatform {
	...
	void initialize(covariant B2ManifoldPlatform manifold, covariant B2TransformPlatform xfA, double radiusA, covariant B2TransformPlatform xfB, double radiusB);
...
abstract class B2Mat33Platform {
	...
	B2Mat33Platform.from3(B2Vec3Platform c1, B2Vec3Platform c2, B2Vec3Platform c3);
...
abstract class B2PolygonShapePlatform {
	...
	void setAsBox4(double hx, double hy, covariant B2Vec2Platform center, double angle);
	B2ShapeType getType();
	int getChildCount();
	bool testPoint(covariant B2TransformPlatform xf, covariant B2Vec2Platform p);
	bool rayCast(covariant B2RayCastOutputPlatform output, covariant B2RayCastInputPlatform input, covariant B2TransformPlatform transform, int childIndex);
...
abstract class B2PrismaticJointDefPlatform {
	...
	void initialize(covariant B2BodyPlatform bodyA, covariant B2BodyPlatform bodyB, covariant B2Vec2Platform anchor, covariant B2Vec2Platform axis);
	B2Vec2Platform get_localAnchorA();
	void set_localAnchorA(covariant B2Vec2Platform arg0);
	B2Vec2Platform get_localAnchorB();
	void set_localAnchorB(covariant B2Vec2Platform arg0);
...
abstract class B2PulleyJointDefPlatform {
	...
	void initialize(covariant B2BodyPlatform bodyA, covariant B2BodyPlatform bodyB, covariant B2Vec2Platform groundAnchorA, covariant B2Vec2Platform groundAnchorB, covariant B2Vec2Platform anchorA, covariant B2Vec2Platform anchorB, double ratio);
...
abstract class B2MotorJointDefPlatform {
	...
	void initialize(covariant B2BodyPlatform bodyA, covariant B2BodyPlatform bodyB);
