...
class _$_AppState implements _AppState {
  ...
  @override
  String toString() {
    return 'AppState(problems: $problems, settings: $settings, authStep: $authStep, authUserData: $authUserData)';
  }
...
abstract class _AppState implements AppState, RedFireState {
  factory _AppState(
      {required IList<ProblemInfo> problems,
      required Settings settings,
      required AuthStepEnum authStep,
