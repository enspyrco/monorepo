...
class _$Settings extends Settings {
  ...
  _$Settings._(
      {this.darkTheme, this.lightTheme, this.brightnessMode, this.platform})
      : super._() {
    if (darkTheme == null) {
    ...
    if (platform == null) {
      throw new BuiltValueNullFieldError('Settings', 'platform');
    }
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, darkTheme.hashCode), lightTheme.hashCode),
